...
describe('CI Visibility Jest Worker Exporter', () => {
  ...
  it('can export traces', () => {
    ...
    expect(send).to.have.been.calledWith([JEST_WORKER_TRACE_PAYLOAD_CODE, JSON.stringify(trace)])
  })
  it('can export coverages', () => {
    ...
    jestWorkerExporter.flush()
    expect(send).to.have.been.calledWith([JEST_WORKER_COVERAGE_PAYLOAD_CODE, JSON.stringify([coverage])])
  })
